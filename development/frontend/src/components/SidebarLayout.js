...
const SidebarLayout = ({ children, role }) => {
  ...
  const menuConfigs = {
    manager: [
      ...
      { id: 'task', label: 'Task', icon: <CheckSquare size={20} />, path: '/manager/tasks' },
      { id: 'report', label: 'Report', icon: <BarChart size={20} />, path: '/manager/reports' },
      { id: 'website-setting', label: 'Website Setting', icon: <Globe size={20} />, path: '/manager/website-settings' },
      { id: 'setting', label: 'Profile Setting', icon: <Settings size={20} />, path: '/manager/settings' },
    ],
    technician: [
      { id: 'task', label: 'My Task', icon: <CheckSquare size={20} />, path: '/technician' },
      { id: 'setting', label: 'Setting', icon: <Settings size={20} />, path: '/technician/settings' },
    ],
    advertiser: [
      ...
      { id: 'setting', label: 'Setting', icon: <Settings size={20} />, path: '/advertiser/settings' },
    ],
    customer: [
      { id: 'setting', label: 'Account Setting', icon: <Settings size={20} />, path: '/customer/settings' },
